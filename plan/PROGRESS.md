...
| 项 | 值 |
|---|---|
| **当前阶段** | **🎉 Phase D1 ✅ + D2 ✅ + D3 ✅ + D4 ✅ + D5 ✅ + D6 ✅ + **D7 ✅**（运维手册：备份/恢复/卸载，`docs/OPERATIONS.md` + 备份脚本补 `uploads`）；**主线 D1–D7 全完成**；**下一步：D5.1b 测试残留清理（待用户确认）/ Phase 10.3+10.5 管理页 UI 实测** |
...
| **D5.1b** | 🔴 **测试残留清理**（待 Q4 确认，**备份后方可执行，逐条列出**） | ⬜ |
