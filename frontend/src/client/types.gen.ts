...
export type AgentStatsOverviewData = {
    /**
     * 统计窗口（自然日，UTC）
     */
    days?: number;
...
export type AgentStatsOverviewResponse = (StatsOverviewResponse);

export type AgentStatsRecentRunsData = {
    limit?: number;
    skip?: number;
};
